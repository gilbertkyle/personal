...
const Navbar = () => {
  const { activeSection, setActiveSection, setTimeOfLastClick } = useActiveSessionContext();
  return (
    <header className="z-[99] relative ">
      <motion.div
        ...
        w-full rounded-none border border-white border-opacity-40
         ...
         backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.25rem] sm:w-[36rem] sm:rounded-full mx-auto -translate-x-1/2 dark:bg-gray-950 dark:border-black/40 dark:bg-opacity-75`}
