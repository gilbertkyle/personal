  ...
  return (
    <section className="mb-28 max-w-[50rem] text-center sm:mb-0">
      ...
      >
        ...
        <a
          className="bg-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110  active:scale-105 transition group cursor-pointer border border-black/10 mx-2"
          href="/CV.pdf"
          download
        >
        ...
        <a
          className="p-4 flex items-center gap-2 text-gray-700 rounded-full border border-black/10 mx-2 bg-white focus:scale-[1.15] hover:scale-[1.15]  active:scale-105 transition hover:text-gray-950"
        ...
        <a
          className="p-4 flex items-center gap-2 text-gray-700 text-[1.35rem] rounded-full border border-black/10 mx-2 bg-white focus:scale-[1.15] hover:scale-[1.15]  active:scale-105 transition hover:text-gray-950"
